  ...
  return (
    <Section title='Results and Discussion' icon='🎯'>
      ...
      <div className='space-y-3'>
        ...
        <P>
          The LiChess dataset does not contain many games outside of the 1500 to
          2700 range. As the vast majority of players — around 95% of the
          population — have a rating outside of this range, the data may not be
          a complete and accurate representation of the range’s actual opening
          demographic. As a result, individuals with lower skillsets are less
          likely to benefit directly from studying these games, since the
          nuances of some positions may not translate well into their level of
          play.{' '}
        </P>
        <P>
          That said, if you're rated below 1500 or simply curious about advanced
          play, the Opening Explorer still offers valuable insights into
          high-level strategies and their frequency of use.
        </P>
      </div>
      ...
      <div className='space-y-3'>
        <H3 text='Human Error' />
        <P>
          Unlike chess engines such as stockfish, human players cannot play
          perfectly. There are two general types of these mistakes that may
          affect this dataset:
        </P>
        <P>
        ...
        <P>
          ...
          However, in shorter time formats such as a blitz or bullet, the
          pressure from the time constraints may lead to lower quality play in
          the mid or end game. This means that players can sometimes run out of
          time before they are able to complete their game. A clear instance of
          this can come from a position like this:
        </P>
      </div>
      ...
      <P>
        This position is a guaranteed mate in 38 for white if played correctly.
        While theoretically possible to execute, a combination of the time
        pressure and the difficulty of the position means that the game will
        likely end in a draw if there is a limited amount of time for white.
        This illustrates how shorter time controls can impact this dataset,
        since it may cut games short despite having an almost guaranteed win
        otherwise.
      </P>
      ...
      <div className='space-y-3'>
        ...
        <P>
          ...
          enhance a players ability to adapt their opening and midgame plays to
