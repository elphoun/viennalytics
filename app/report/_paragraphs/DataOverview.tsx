  ...
  <Section title="Data Overview" icon="📊">
    ...
    <div className="space-y-1">
      ...
      <Table
        rows={[
          {
            field: "White Wins",
            value: <span className="text-green-400">28,492 (40.4%)</span>,
          },
          {
            field: "Black Wins",
            value: <span className="text-red-400">22,887 (32.5%)</span>,
          },
          {
            field: "Draws",
            value: <span className="text-yellow-400">19,131 (27.1%)</span>,
          },
        ]}
      />
    </div>
    ...
    <div className="space-y-1">
      ...
      <Table
        rows={[
          {
            field: "Number of Unique Openings",
            value: <span className="text-purple-400">1,300</span>,
          },
        ]}
      />
    </div>
    ...
    <div className="space-y-1">
      ...
      <Table
        rows={[
          {
            field: "Minimum ELO",
            value: <span className="text-orange-400">635</span>,
          },
          {
            field: "Maximum ELO",
            value: <span className="text-orange-400">2,273</span>,
          },
        ]}
      />
    </div>
