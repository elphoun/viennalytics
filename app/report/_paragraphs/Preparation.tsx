...
const Preparation = memo(() => (
    ...
    "variation": "General"
            ...
            <DataCard title="PGN (Portable Game Notation)">
                <P>Contains metadata about an individual game, including its move sequence in algebraic notation</P>
                <CodeBlock
...
1.e4 e5 2.Nf3 Nf6 3.Nxe5 d6 4.Nf3 Nxe4`}
        ...
        <P>
            ...
            . Stockfish is a bot that analyzes a chess position and provides analysis on the current evaluation and the best next move. While it is primarily used for cheating and giving{' '}
            <PromptOnHighlight
                prompt={<Quote quote="I rarely play against engines at all, because they just make me feel so stupid and useless." author="Magnus Carlsen (🗿)" />}
            >
                Magnus Carlsen an inferiority complex
            </PromptOnHighlight>, I used it in this project to provide further analysis on the final position of the openings.
        </P>

        <ImageDisplay src="/stockfish.png" caption="Stockfish" width={250} height={250} />
...
→ opening_stats.json       # A compilation of all game data. Backend for the opening explorer`}
        ...
        <P>
            There are 6 other files dedicated to each of the graphs (so your poor computer and Vercel don’t explode from computing <b>486MB</b>, which is how large the <code>processed_all_games.json</code> file is). You can checkout the{' '}
            <Hyperlink link="https://github.com/elphoun/viennalytics">
                <Highlight
                    text="Github"
                    icon={<GithubInlineIcon />}
                />
            </Hyperlink>{' '}
            to see the code and some specific details behind the design choices of this project in the READMEs.
        </P>
    </Section>
));
