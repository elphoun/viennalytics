...
const Quote = memo(({ quote, author, className = "" }: QuoteProps) => (
    <blockquote className={`relative p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-lg border-l-4 border-orange-400/60 backdrop-blur-sm ${className}`}>
