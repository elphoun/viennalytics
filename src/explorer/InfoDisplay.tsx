          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div className={`px-2 py-1 rounded text-xs font-medium ${getEvalClassName(move.eval)}`}>
                  {evalDisplay}
                </div>
              </div>
            </div>
    ...
    <div className="p-2 flex flex-col lg:flex-row h-full w-full gap-2 bg-gradient-to-br from-black/10 to-black/30 max-w-full overflow-y-auto lg:overflow-hidden">
      ...
      <div className="flex flex-col h-auto lg:h-full w-full items-center gap-2 justify-start lg:justify-between lg:flex-[2] min-h-0 min-w-0 overflow-hidden">
        ...
        <InfoDisplayGrid
          ...
          className="p-0 hover:ring-amber-400/70 transition-all duration-200 w-full h-full min-h-fit"
        >
          {eloTrendCharts}
        </InfoDisplayGrid>
        {/* Best Moves Section */}
        <InfoDisplayGrid
          ...
          className="hover:ring-amber-400/70 transition-all duration-200 w-full h-full min-h-0"
        >
