...
const MethodologySection = () => (
  <ReportSection id="Methodology" title="Methodology" icon="🔬">
    <Paragraph>
    ...
    <CodeBlock className="text-gray-900">
      <div className="flex items-center mb-2">
        <span className="text-blue-600 mr-2">→</span>
        <span>all_games_info.csv → Contains the raw extracted data from the PGNs</span>
      </div>
      <div className="flex items-center mb-2">
        <span className="text-blue-600 mr-2">→</span>
        <span>processed_all_games.json → Contains the processed game data from the PGNs</span>
      </div>
      <div className="flex items-center mb-2">
        <span className="text-blue-600 mr-2">→</span>
        <>opening_stats.json → A compilation of all of the game data. This is the file that serves as the backend for the <b>opening explorer</b>.</>
      </div>
    </CodeBlock>

    <Paragraph>
    There are 6 other files dedicated to each of the graphs (so your poor computer and Vercel don’t explode from computing <b>486MB</b>, which is how large the <code className="italic">processed_all_games.json</code> file is). You can checkout the 
